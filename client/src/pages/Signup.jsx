      ...
      <main className="signup-main">
        ...
        <div className="signup-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="signup-form-group">
              <label className="signup-label" htmlFor="signup-password">Password (6+ characters)</label>
          ...
          <button className="btn-google" onClick={handleGithubSignUp} type="button" style={{ marginBottom: 0 }}>
          ...
          <div className="signup-login-prompt" style={{ marginTop: '16px' }}>
